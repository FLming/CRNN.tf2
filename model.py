...
def ResNet(inputs):
    """Related paper: http://openaccess.thecvf.com/content_ICCV_2017/papers/Cheng_Focusing_Attention_Towards_ICCV_2017_paper.pdf"""
    ...
    x = keras.layers.MaxPool2D(pool_size=[2, 2], strides=[2, 1], padding="same")(x)
